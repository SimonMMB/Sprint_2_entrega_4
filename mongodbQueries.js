...
db.restaurants.find({"cuisine": "Seafood", "name": {$not: { $regex: "^wil", $options: "i"}}}, {"_id": 0, "restaurant_id": 1, "name": 1, "borough": 1, "cuisine": 1})
...
db.restaurants.find({"grades": {$elemMatch: { "grade": "A", "score": 11, "date": new ISODate("2014-08-11T00:00:00Z")}}}, {"_id": 0, "restaurant_id": 1, "name": 1, "grades": 1})
...
db.restaurants.find({"grades.1.grade": "A", "grades.1.score": 9, "grades.1.date": new ISODate("2014-08-11T00:00:00Z")}, {"_id": 0, "restaurant_id": 1, "name": 1, "grades": 1})
...
db.restaurants.find({"name": {$regex: "mon", $options: "i"}}, {"_id": 0, "name": 1, "borough": 1, "address.coord.0": 1, "address.coord.1": 1, "cuisine": 1})
...
db.restaurants.find({"name": {$regex: "^mad", $options: "i"}}, {"_id": 0, "name": 1, "borough": 1, "address.coord.0": 1, "address.coord.1": 1, "cuisine": 1})